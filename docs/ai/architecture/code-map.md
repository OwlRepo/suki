...
- messaging + AI: `apps/api/src/messaging/*` owns provider response normalization, delivery events, metering, parameterized Semaphore false-rejection reconciliation, and manual fallback; `apps/api/src/ai/*` owns generation
