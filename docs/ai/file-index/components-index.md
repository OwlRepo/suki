...
|---|---|---|---|---|---|---|
| `apps/web/src/components/navigation/*` | navigation shell and menus | nav components/config | React, Next routing | dashboard layouts | adaptive desktop/mobile navigation | Medium |
