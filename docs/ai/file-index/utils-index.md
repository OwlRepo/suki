...
| `apps/web/src/lib/onboarding.ts` | onboarding domain helpers | onboarding helpers | app types/utils | onboarding UI | deterministic 6-step MVP setup flow derivation | Medium |
