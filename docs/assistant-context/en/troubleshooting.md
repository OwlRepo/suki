---
id: en-troubleshooting-common-recovery
locale: en
category: troubleshooting
intents: ["not working", "error", "failed", "can't do this", "assistant issue"]
relatedRoutes: ["/help", "/settings", "/dashboard"]
toolBindings: ["route_guidance", "get_billing_status", "get_ai_usage"]
priority: high
lastUpdated: 2026-05-10
quickAnswer: Use Help Center first, then verify usage and settings when features seem unavailable.
---
- Start with Help Center article search using the exact task name.
