---
id: en-help-center-guided-support
locale: en
...
- Use the search bar with simple task words (add customer, time slots, monthly sales).
...
- Common mistake: skipping related links after reading an article.
- Recovery: use action links to complete the task immediately.
