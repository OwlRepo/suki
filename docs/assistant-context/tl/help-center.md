---
id: tl-help-center-guided-support
locale: tl
category: troubleshooting
intents: ["help center", "documentation", "guided onboarding replay", "how to use"]
...
- Gamitin ang search gamit ang malinaw na task words (add customer, time slots, monthly sales).
...
- Karaniwang mali: binabasa lang ang article pero walang action.
- Recovery: gamitin agad ang action links para matapos ang task.
