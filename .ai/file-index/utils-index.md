...
| `apps/web/src/lib/auth-client.ts` | First-party auth API client helpers | Consumed by sign-in/sign-up pages and session hook | Cookie-credentialed password sign-in plus sign-up OTP/password calls to `/auth/*` endpoints |
