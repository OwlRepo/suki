...
export const ASSISTANT_TOOL_POLICIES = {
  ...
  get_onboarding_status: aggregate(false),
  get_subscription_and_limits: aggregate(false),
  ...
  get_automation_runs: aggregate(true),
  diagnose_reminder_issue: aggregate(true),
  diagnose_booking_issue: aggregate(true),
  explain_message_status: aggregate(false),
  explain_sms_usage: aggregate(false),
  get_recommended_next_actions: aggregate(true),
  find_customers: {
